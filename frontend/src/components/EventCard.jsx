      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 items-stretch">
        ...
        <div className="lg:col-span-8 p-5 sm:p-6 lg:px-8 xl:px-9 flex flex-col">
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
           <button onClick={handleSeeDetails} type="button" className="bg-gray-200 text-gray-800 hover:bg-gray-300 text-sm sm:text-base font-medium py-2 px-4 rounded-xl transition">
              See details
            </button>

           <button onClick={handleBuyNow} type="button" className="bg-black text-white hover:bg-gray-800 text-sm sm:text-base font-medium py-2 px-4 rounded-xl transition">
              Buy now
            </button>
          </div>

          <div className="flex justify-end items-center gap-4 mt-8">
            <button type="button" className="text-sm text-rose-600 font-medium hover:underline">
              See more events
            </button>
          </div>
        </div>
